...
(function (root) {
  ...
  const MESSAGES = {
    zh: {
      ...
      "popup.sharePage": "分享此頁筆記",
      "popup.shareTitle": "上傳這一頁並複製公開分享連結（需先在「管理所有筆記」設定 GitHub 備份，且 repo 為公開並啟用 GitHub Pages）",
      "popup.statusSharing": "上傳此頁中…",
      "popup.statusShareCopied": "分享連結已複製！記得到 repo 的 Settings → Pages 啟用 GitHub Pages，別人才打得開。",
      "popup.statusShareReady": "已上傳，分享連結：{link}",
      "popup.errShareNoGithub": "請先在「管理所有筆記」裡設定並填好 GitHub 備份（Token／儲存庫等）",
      "popup.errShareNoNotes": "本頁沒有筆記可分享",
      "popup.errShareUnavailable": "分享功能載入失敗，請重開 popup",
      "popup.errShareFail": "分享失敗，請稍後再試",
      ...
      "manager.sharePage": "分享此頁",
      "manager.shareTitle": "上傳這一頁並複製公開分享連結（需 repo 為公開並啟用 GitHub Pages）",
      "manager.statusSharing": "上傳此頁中…",
      "manager.statusShareCopied": "分享連結已複製！記得到 repo 的 Settings → Pages 啟用 GitHub Pages，別人才打得開。",
      "manager.statusShareReady": "已上傳，分享連結：{link}",
      "manager.statusShareFail": "分享失敗，請稍後再試",
    ...
    en: {
      ...
      "popup.sharePage": "Share this page",
      "popup.shareTitle": "Upload this page and copy a public share link (set up GitHub backup in \"Manage all notes\" first; repo must be public with GitHub Pages enabled)",
      "popup.statusSharing": "Uploading this page…",
      "popup.statusShareCopied": "Share link copied! Enable GitHub Pages in the repo's Settings → Pages so others can open it.",
      "popup.statusShareReady": "Uploaded. Share link: {link}",
      "popup.errShareNoGithub": "Set up your GitHub backup (token, repo, etc.) in \"Manage all notes\" first",
      "popup.errShareNoNotes": "No notes on this page to share",
      "popup.errShareUnavailable": "Share module failed to load — reopen the popup",
      "popup.errShareFail": "Share failed, please try again later",
      ...
      "manager.sharePage": "Share this page",
      "manager.shareTitle": "Upload this page and copy a public share link (repo must be public with GitHub Pages enabled)",
      "manager.statusSharing": "Uploading this page…",
      "manager.statusShareCopied": "Share link copied! Enable GitHub Pages in the repo's Settings → Pages so others can open it.",
      "manager.statusShareReady": "Uploaded. Share link: {link}",
      "manager.statusShareFail": "Share failed, please try again later",
