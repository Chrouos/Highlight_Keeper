...
(function (root) {
  ...
  const MESSAGES = {
    zh: {
      ...
      "prompt.outputLang": "請用繁體中文輸出：原文引用片段保留原文，其餘（重點、摘要、心智圖節點、reason）一律以繁體中文撰寫。",
    ...
    en: {
      ...
      "prompt.outputLang": "Write your output in English: keep quoted source snippets verbatim, but write everything else (highlights, summary, mind-map nodes, reason) in English.",
      "cat.motivation": "Motivation / Background",
      "cat.method": "Method / Approach",
      "cat.pros": "Pros / Benefits",
      "cat.cons": "Cons / Limitations",
      "cat.conclusion": "Conclusion / Key points",
