...
(function (root) {
  ...
  const MESSAGES = {
    zh: {
      ...
      "popup.shareLink": "複製分享連結",
      "popup.shareLinkTitle": "對方點開原文網址，裝了 Highlight Keeper 就會跳出「匯入」，一鍵收下你的筆記",
      "popup.statusLinkCopied": "分享連結已複製！對方點開就是原文，裝了擴充會自動跳「匯入」",
      "popup.statusLinkUploading": "筆記較多，改上傳到 GitHub 產生連結中…",
      "popup.statusLinkCopiedGithub": "已複製 GitHub 分享連結（筆記較多放不進網址，改放你的備份 repo）",
      "popup.errLinkTooLong": "筆記太多放不進連結。請先在「管理所有筆記」設定 GitHub 備份，或改用「下載本頁 JSON」",
      "popup.errLinkShare": "產生分享連結失敗，請稍後再試",
      "popup.aiAutoHighlight": "複製 AI 畫重點 Prompt",
      // ── popup（重做後的三個快捷區塊）─────────────────
      "popup.stepCopyTitle": "複製 Prompt",
      "popup.stepCopyDesc": "把本頁全文與色票組成 Prompt，貼到 ChatGPT 讓它畫重點、寫摘要。",
      "popup.copyMindmapPrompt": "改複製心智圖 Prompt",
      "popup.statusMindmapCopied": "已複製心智圖 Prompt，貼到 ChatGPT 後把回覆貼回步驟 2",
      "popup.stepPasteTitle": "貼上",
      "popup.stepPasteDesc": "把 AI 的回覆貼進來，會自動套用重點、摘要、標籤與心智圖。",
      "popup.stepShareTitle": "分享此網頁",
      "popup.stepShareDesc": "對方點開就是原文；裝了 Highlight Keeper 會跳出「匯入」收下你的筆記。",
      "popup.copyNotesShort": "複製 Markdown",
      "popup.downloadNotesShort": "下載 JSON",
      "popup.panelHint": "顏色、標籤、搜尋、備份都在面板裡",
      "popup.markCountValue": "本頁 {count} 個標記",
      "popup.copied": "已複製 ✓",
      "popup.paletteTitle": "標註顏色",
      "panel.deepResearch": "延伸補充",
      "panel.deepResearchHint":
        "讓 AI 先想過一輪，再補文章沒寫到的背景、反面說法與延伸探索方向；結果接在摘要後面。",
      "ai.extraHeading": "延伸補充（未對應到句子）",
      "ai.extraNotePrefix": "延伸：",
      "ai.sourceNotePrefix": "來源：",
      "ai.sourceSearchHint": "AI 憑記憶提供的線索，點一下用 Google 查證",
      "ai.extraAttached": "{count} 句加了延伸",
      "ai.extraAttachedSuffix": "，{count} 句加了延伸",
      "panel.recolorLegacy": "把舊的深色標註換淺",
      "panel.recolorLegacyHint": "把之前用飽和色畫的標註，換成對應的新淺色（所有頁面）",
      "panel.recolorConfirm": "要把所有頁面的舊深色標註換成新的淺色嗎？此動作無法復原。",
      "panel.recolorDone": "已換色 {count} 個標註",
      "panel.recolorNone": "沒有找到需要換色的舊標註",
      ...
      "manager.tagManager": "標籤整理",
      "manager.tagManagerHint": "改名、併入常用標籤或刪除，一次套用到所有頁面；用得少的排前面。",
      "manager.tagMgrPages": "{count} 頁",
      "manager.tagMgrPlaceholder": "改名或併入其他標籤…",
      "manager.tagMgrApply": "套用",
      "manager.tagMgrDelete": "刪除",
      "manager.tagMgrConfirmDelete": "確定要刪除標籤「{tag}」？會從 {count} 頁移除，頁面本身不受影響。",
      "manager.tagMgrEmpty": "目前沒有任何標籤。",
      "manager.statusTagRenamed": "已把「{old}」改為「{new}」（{count} 頁）",
      "manager.statusTagDeleted": "已刪除標籤「{tag}」（{count} 頁）",
      "manager.tagSuggestLabel": "既有標籤：",
      "manager.tagSuggestTitle": "已有 {count} 頁使用，點一下加到本頁",
      "manager.tagFilterMore": "更多（{count}）▾",
      "manager.tagFilterCollapse": "收合 ▴",
      "manager.shareLink": "分享連結",
      "manager.shareLinkTitle": "對方點開原文網址，裝了 Highlight Keeper 就會跳出「匯入」，一鍵收下這頁筆記",
      "manager.statusLinkCopied": "分享連結已複製！對方點開就是原文，裝了擴充會自動跳「匯入」",
      "manager.statusLinkUploading": "筆記較多，改上傳到 GitHub 產生連結中…",
      "manager.statusLinkCopiedGithub": "已複製 GitHub 分享連結（筆記較多放不進網址，改放你的備份 repo）",
      "manager.errLinkTooLong": "筆記太多放不進連結。請先設定上方 GitHub 備份，或改用「下載 JSON」",
      "manager.errLinkShare": "產生分享連結失敗，請稍後再試",
      "notesMd.tags": "標籤",
      "notesMd.highlights": "重點",
      "notesMd.summary": "摘要筆記",
      "notesMd.mindmap": "心智圖大綱",
      "share.detected": "偵測到分享筆記：{title}（{count} 筆標註）",
      "share.importBtn": "匯入到我的 Highlight Keeper",
      "share.importing": "匯入中…",
      "share.done": "✓ 已匯入，本頁套上 {count} 筆標註",
      "share.rawDone": "✓ 已匯入（本頁共 {count} 筆）。",
      "share.openSource": "開啟原文 →",
      "share.fail": "匯入失敗，請稍後再試",
      "share.conflict": "這頁你已有 {count} 筆筆記，要怎麼處理？",
      "share.merge": "併入",
      "share.overwrite": "覆蓋",
      "share.cancel": "取消",
      "share.cancelled": "已取消匯入",
      "share.close": "關閉",
      "share.mdOtherPage": "（別頁的分享筆記，已嘗試套用到本頁）",
      ...
      "manager.mergeDuplicatesTitle": "把只差網址參數、或同網站同標題的同一頁合併成一筆",
      "manager.mergeByTitleMark": "（同網站同標題）",
    ...
    en: {
      ...
      "popup.shareLink": "Copy share link",
      "popup.shareLinkTitle": "Recipient opens the original page; with Highlight Keeper installed they get a one-click Import",
      "popup.statusLinkCopied": "Share link copied! It opens the original page — the extension offers Import automatically",
      "popup.statusLinkUploading": "Lots of notes — uploading to GitHub to build the link…",
      "popup.statusLinkCopiedGithub": "GitHub share link copied (too many notes for a URL, stored in your backup repo)",
      "popup.errLinkTooLong": "Too many notes for a link. Set up GitHub backup in \"Manage all notes\" or use \"Download JSON\"",
      "popup.errLinkShare": "Failed to build share link, please try again",
      "popup.aiAutoHighlight": "Copy AI highlight prompt",
      // ── popup (redesigned quick actions) ───────────────
      "popup.stepCopyTitle": "Copy prompt",
      "popup.stepCopyDesc": "Builds a prompt from this page's text and your palette — paste it into ChatGPT to get highlights and a summary.",
      "popup.copyMindmapPrompt": "Copy mind-map prompt instead",
      "popup.statusMindmapCopied": "Mind-map prompt copied — paste the reply back into step 2",
      "popup.stepPasteTitle": "Paste",
      "popup.stepPasteDesc": "Paste the AI reply here — highlights, summary, tags and mind map are applied automatically.",
      "popup.stepShareTitle": "Share this page",
      "popup.stepShareDesc": "The link opens the original article; anyone with Highlight Keeper gets an Import prompt.",
      "popup.copyNotesShort": "Copy Markdown",
      "popup.downloadNotesShort": "Download JSON",
      "popup.panelHint": "Colors, tags, search and backup live in the panel",
      "popup.markCountValue": "{count} marks",
      "popup.copied": "Copied ✓",
      "popup.paletteTitle": "Highlight colors",
      "panel.deepResearch": "Extra context",
      "panel.deepResearchHint":
        "Ask the AI to think first, then add background, counterpoints and follow-up directions the article leaves out. Appended after the summary.",
      "ai.extraHeading": "Extra context (unmatched)",
      "ai.extraNotePrefix": "Extra: ",
      "ai.sourceNotePrefix": "Source: ",
      "ai.sourceSearchHint": "A lead the AI wrote from memory — click to verify on Google",
      "ai.extraAttached": "{count} sentences extended",
      "ai.extraAttachedSuffix": ", {count} sentences extended",
      "panel.recolorLegacy": "Lighten old highlights",
      "panel.recolorLegacyHint":
        "Recolor highlights made with the old saturated palette to their lighter equivalents (all pages)",
      "panel.recolorConfirm":
        "Recolor all old saturated highlights across every page to the new lighter palette? This can't be undone.",
      "panel.recolorDone": "Recolored {count} highlights",
      "panel.recolorNone": "No old highlights found",
      ...
      "manager.tagManager": "Tidy tags",
      "manager.tagManagerHint": "Rename, merge into a common tag, or delete — applied across all pages; rarely used tags first.",
      "manager.tagMgrPages": "{count} page(s)",
      "manager.tagMgrPlaceholder": "Rename or merge into another tag…",
      "manager.tagMgrApply": "Apply",
      "manager.tagMgrDelete": "Delete",
      "manager.tagMgrConfirmDelete": "Delete tag \"{tag}\"? It will be removed from {count} page(s); the pages themselves are untouched.",
      "manager.tagMgrEmpty": "No tags yet.",
      "manager.statusTagRenamed": "Renamed \"{old}\" to \"{new}\" ({count} page(s))",
      "manager.statusTagDeleted": "Deleted tag \"{tag}\" ({count} page(s))",
      "manager.tagSuggestLabel": "Existing tags:",
      "manager.tagSuggestTitle": "Used on {count} page(s) — click to add to this page",
      "manager.tagFilterMore": "More ({count}) ▾",
      "manager.tagFilterCollapse": "Collapse ▴",
      "manager.shareLink": "Share link",
      "manager.shareLinkTitle": "Recipient opens the original page; with Highlight Keeper installed they get a one-click Import",
      "manager.statusLinkCopied": "Share link copied! It opens the original page — the extension offers Import automatically",
      "manager.statusLinkUploading": "Lots of notes — uploading to GitHub to build the link…",
      "manager.statusLinkCopiedGithub": "GitHub share link copied (too many notes for a URL, stored in your backup repo)",
      "manager.errLinkTooLong": "Too many notes for a link. Set up GitHub backup above, or use \"Download JSON\"",
      "manager.errLinkShare": "Failed to build share link, please try again",
      "notesMd.tags": "Tags",
      "notesMd.highlights": "Highlights",
      "notesMd.summary": "Summary",
      "notesMd.mindmap": "Mind map outline",
      "share.detected": "Shared notes detected: {title} ({count} highlights)",
      "share.importBtn": "Import to my Highlight Keeper",
      "share.importing": "Importing…",
      "share.done": "✓ Imported — {count} highlights applied on this page",
      "share.rawDone": "✓ Imported ({count} total on this page).",
      "share.openSource": "Open source page →",
      "share.fail": "Import failed, please try again",
      "share.conflict": "You already have {count} notes on this page. What to do?",
      "share.merge": "Merge",
      "share.overwrite": "Overwrite",
      "share.cancel": "Cancel",
      "share.cancelled": "Import cancelled",
      "share.close": "Close",
      "share.mdOtherPage": "(shared notes from another page — applied here anyway) ",
      ...
      "manager.mergeDuplicatesTitle": "Merge pages that differ only by URL parameters, or share the same site and title",
      "manager.mergeByTitleMark": " (same site & title)",
